...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call <SID>X("WildMenu", s:comment, s:line, "reverse")
  ...
  if !has("gui_running")
    ...
    " ugly fix for consistent colors in terminal
    ...
    call <SID>X("StatusLine", "", s:line, "none")
    call <SID>X("StatusLineNC", s:comment, s:line, "none")
    call <SID>X("VertSplit", s:line, "", "")
  endif
  ...
  call <SID>X("Keywrod", s:purple, "", "")

  " VimShell
  call <SID>X("VimShellError", s:red, "", "")
  call <SID>X("VimShellPrompt", s:blue, "", "")
  call <SID>X("VimShellNormal", s:foreground, "", "")

  " ZSH
  call <SID>X("zshKeyword", s:blue, "", "")
  call <SID>X("zshCommands", s:blue, "", "")

  " SH
  call <SID>X("shConditional", s:blue, "", "")
  call <SID>X("shStatement", s:orange, "", "")

  " screen
  call <SID>X("screenCommands", s:blue, "", "")
  ...
  call <SID>X("javaScriptDeprecated", s:foreground, "", "")
  call <SID>X("javaScriptMessage", s:foreground, "", "")
  call <SID>X("javaScriptFunction", s:purple, "", "")
  call <SID>X("javaScriptFuncExp", s:foreground, "", "")
  call <SID>X("javaScriptBrowserObjects", s:foreground, "", "")
  ...
  call <SID>X("javaScriptHtmlElemProperties", s:foreground, "", "")
  call <SID>X("javaScriptHtmlElemAttrs", s:foreground, "", "")

  " HTML/JavaScript
  call <SID>X("javaScript", s:red, "", "")
  call <SID>X("jsOperator", s:red, "", "")
  call <SID>X("javaScriptDOMProperties", s:foreground, "", "")
  ...
  call <SID>X("htmlTitle", s:comment, "", "")
  call <SID>X("htmlH1", s:comment, "", "")
  call <SID>X("htmlH2", s:comment, "", "")
  call <SID>X("htmlH3", s:comment, "", "")
  call <SID>X("htmlLink", s:blue, "", "")
  call <SID>X("cssTagName", s:foreground, "", "")
  call <SID>X("cssMediaKeyword", s:comment, "", "")
  ...
  call <SID>X("DiffText", s:foreground, s:background, "")
  ...
  " VimShell
  call <SID>X("vimshellCommand", s:purple, "", "")

  " GLSL
  call <SID>X("glslStatement", s:purple, "", "")

  " XML
  call <SID>X("xmlEndTag", s:blue, "", "")
  call <SID>X("xmlDocTypeKeyword", s:comment, "", "")

  " TaskPaper
  call <SID>X("taskpaperProject", s:blue, "", "")
  call <SID>X("taskpaperListItem", s:blue, "", "")
  call <SID>X("taskpaperContext", s:blue, "", "")
  call <SID>X("taskpaperDone", s:selection, "", "")

  " GIT
  call <SID>X("gitCommitSummary", s:foreground, "", "")
